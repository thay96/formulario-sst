...
const crearRegistro = async (req, res) => {
    try {
        ...
        const [result] = await db.query(
            ...
            (nombre_completo, cedula, fecha, cargo, quedo_clara_la_informacion, observacion) 
            VALUES (?, ?, ?, ?, ?, ?)`,
            [nombre_completo, cedula, fecha, cargo, quedo_clara_la_informacion, observacion || null]
        );
